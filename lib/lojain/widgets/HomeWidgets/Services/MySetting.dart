...
class _MySettingState extends State<MySetting> {
  ...
  Widget build(BuildContext context) {
    double font = (context.watch<DropdownCubit>().state.selectedValue == 'Larg'
        ? 24
        : context.watch<DropdownCubit>().state.selectedValue == 'Small'
            ? 14
            : 16);
        var selectlang=context.read<Selection>().state;   
        print(selectlang); 
            ...
            Container(
              ...
              child: Text(
               context.watch<Selection>().state == 1
                                    ? 'اعداداتي':  'My Setting',
                style: TextStyle(fontWeight: FontWeight.w700, fontSize: font),
              ),
            ),
            Container(
                      ...
                      Row(
                        children: [
                         ...
                         context.watch<Selection>().state == 1
                                    ? 'الثيم':    'Theme',
                            style: TextStyle(
                                fontWeight: FontWeight.w400, fontSize: font),
                          ),
                        ],
                      ),
                      BlocBuilder<SelectionTheme, int?>(
                          builder: (context, select) {
                        return Row(children: [
                          Text(
                            select == 4 ?   context.watch<Selection>().state == 1
                                    ? 'نهاري': 'light' :  context.watch<Selection>().state == 1
                                    ? 'ليلي' 
                                    :'Dark',
                            style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Image.asset(
                              'images/fluent_text-font-size-16-filled.png'),
                          SizedBox(
                            width: 10,
                          ),
                          Text(
