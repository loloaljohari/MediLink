...
class Filloutmedicalfile extends StatefulWidget {
  Filloutmedicalfile({Key? key}) : super(key: key);

  @override
  State<Filloutmedicalfile> createState() => _FilloutmedicalfileState();
}

class _FilloutmedicalfileState extends State<Filloutmedicalfile> {
  TextEditingController name = TextEditingController();

  TextEditingController ray_laboratory = TextEditingController();

  TextEditingController ray_date = TextEditingController();
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    children: [
                                          ...
                                          child: Theme(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration:  InputDecoration(
                                                ...
                                                labelText:context.watch<Selection>().state == 1 ? 'ادخل اسم تحليل الاشعة' : 'Enter ray name ',
                                                  ...
                                                  child: Theme(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      decoration:
                                                        ...
                                                        fillColor: Colors.white,
                                                        labelText:
                                                         context.watch<Selection>().state == 1 ? 'ادخل مختبر الشعاع' :     'enter ray laboratory',
                                                        labelStyle: TextStyle(
                                                            color: Colors.white,
                                                            fontSize: 14,
                                                            fontStyle: FontStyle
                                                  ...
                                                  child: Theme(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      decoration:
                                                        ...
                                                        fillColor: Colors.white,
                                                        labelText:
                                                           context.watch<Selection>().state == 1 ? 'تاريح الشعاع yyyy-mm-dd' : ' ray date yy-mm-dd',
                                                        labelStyle: TextStyle(
                                                            color: Colors.white,
                                                            fontSize: 14,
                                                            fontStyle: FontStyle
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                Text(
                                                 context.watch<Selection>().state == 1 ? 'اضف صورة الشعاع' : 'add image ray ',
                                                  style: TextStyle(
                                                      fontSize: 17,
                                                      fontWeight:
                                                          FontWeight.w700),
                                      ...
                                      BlocBuilder<Postmedicalfile, bool>(
                                        ...
                                        return ElevatedButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              var isSuccess = await context
                                                  .read<Postmedicalfile>()
                                                  .post(
                                                      ray_name: name.text,
                                                      ray_laboratory:
                                                          ray_laboratory.text,
                                                      ray_date: ray_date.text,
                                                      ray_image: path);
