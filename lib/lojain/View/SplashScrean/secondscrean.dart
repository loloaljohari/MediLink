...
import 'package:MediLink/lojain/View/OnboardingScrean/choosethetheme.dart';
import 'package:MediLink/lojain/widgets/SelectThemeWidgets/LogoText.dart';
...
class _MyWidget4State extends State<MyWidget4> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(milliseconds: 900), () async {
      ...
      sharedPreferences.getBool('firstopen')==false?  Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(builder: (context) => HomePages()),
          (route) => false):
      Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(builder: (context) => Choosethetheme()),
          (route) => false);
    });
  }
          ...
          child: Stack(
            ...
            children: [
              ...
              Align(
                  ...
                  child: Image.asset('images/lojain.png')),
              Align(
